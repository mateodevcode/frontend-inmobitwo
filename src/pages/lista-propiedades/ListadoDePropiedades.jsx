    ...
    <div className="w-[75%] h-full">
      <div className="w-full flex items-center justify-end h-16">
        <div className="flex items-center mx-4 text-sm mt-2">
          ...
          <div className="px-4 py-2 border border-tercero font-semibold text-tercero bg-primero">
            Relevancia
          </div>
          <div className="px-4 py-2 border border-segundo/40 font-semibold text-segundo bg-primero">
            Baratos
          </div>
          <div className="px-4 py-2 border border-segundo/40 font-semibold text-segundo bg-primero">
            Recientes
          </div>
          <div className="flex items-center gap-2 px-4 py-2 border border-segundo/40 font-semibold text-segundo bg-primero">
            Más
            <div>
              <MdArrowDropDown />
            </div>
      ...
      <div className="flex flex-col gap-4 p-4">
        {anuncios.map((anu) => {
          return (
            <div
              className="flex items-center h-64 w-full rounded-md shadow-lg hover:shadow-xl shadow-black/10 transition duration-300 group"
              key={anu}
            >
                ...
                <div className="flex flex-col">
                  ...
                  <div className="px-4">
                    ...
                    <div className="text-sm flex items-center gap-2">
                      <p>
                        Garaje incluido 2 hab. 85 m² 7ª planta exterior con
                        ascensor
                      </p>
                    ...
                    <div className="text-sm mt-2">
                      ALQUILER TEMPORAL ALQUILER AMUEBLADO TRES DORMITORIOS EN
                      CIUDAD NARANCO Próximo a la estación de autobuses y trenes
                      y a un paso del Colegio Santa María del Naranco. Rodeado
                    </div>
