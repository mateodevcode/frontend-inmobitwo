...
import MapaInmuebles from "@/pages/mapa-inmuebles/MapaInmuebles";
      ...
      if (hasCity) {
        ...
        if (res.success && res.data) {
          ...
          res = await apiBackend(
            `/api/location-geojson?tipo=departamento&dept=${slug}`,
          );
          tipo = "departamento";
